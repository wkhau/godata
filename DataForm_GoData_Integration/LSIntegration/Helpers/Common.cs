...
namespace LSIntegration.Helpers
{
    public class Common
    {
        ...
        public LoginTokenDto GetLoginDetails(string email, string password, string BaseURL)
        {
            ...
            //string method_name = "users/login";
            //string baseURL = "http://godata_shw.who.int/api/oauth/token?access_token=Token";

            string response_text = ExecuteApiRequest_JSON(json, BaseURL);
            dynamic response_json = ConvertFromJSON(response_text);

            //string str_response_json = response_json.toString();
            //response_text = response_text.Replace("\"", "'");

            //response_text = "{\"response\":{\"token_type\":\"bearer\",\"expires_in\":600,\"access_token\":\"HuRuyevFYA8mWJjyDRGypAaSbR98zD68CSvGBxUUZS2Q2pngPIQaMD1GfdZbtmaR\"}}";
            //response_json = "{{"response": {"token_type": "bearer","expires_in": 600,"access_token": "ign9w8NG2tJU9Xqy75Wwpd7wlPRZLbOIxETe8QeRvlelNqu1zrqHftufufddHy30"}}}";
            ...
            //json_format = "[{\"token_type\": \"bearer\",\"expires_in\": 600,\"access_token\": \"ign9w8NG2tJU9Xqy75Wwpd7wlPRZLbOIxETe8QeRvlelNqu1zrqHftufufddHy30\"}]";
            ...
            //lt.userid = response_json.userId;
        ...
        public string GetPersonIdByLSToken(string Lstoken)
        {
            ...
            return personId;
            //return "3c493744-65ce-40ca-96ca-db4175ae0a8d";
        }
